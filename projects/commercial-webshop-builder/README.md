# Classic Parts Finder

Classic Parts Finder is a productized sourcing service that helps classic-car owners and restorers turn an incomplete parts request into a better-specified search and a documented manual sourcing result.

The project is in validation, not production development.
...
- [spike01/hypothesis.md](spike01/hypothesis.md) — original commercial hypothesis.

### Spike03

- [spike03/README.md](spike03/README.md) — phase overview.
- [spike03/scope.md](spike03/scope.md) — scope and completion criteria.
- [spike03/architecture-and-formulas.md](spike03/architecture-and-formulas.md) — intake and case-view architecture.
- [spike03/validation-evidence.md](spike03/validation-evidence.md) — privacy-safe technical evidence.
- [spike03/go-no-go.md](spike03/go-no-go.md) — final phase decision.
...
- [spike04/category-based-intake-architecture.md](spike04/category-based-intake-architecture.md) — proposed intake design.
...
The canonical dossier summarizes rather than copies every historical artifact.
